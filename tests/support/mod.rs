...
/// every optional capability the client binary supports and the surface codecs
/// it speaks, most capable first.
...
/// Performs the endpoint handshake with explicit capabilities and surface codec
/// preferences. `&[SURFACE_CODEC_V1]` reproduces a stock 0.9.0 client.
